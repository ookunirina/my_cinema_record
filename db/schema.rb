...
ActiveRecord::Schema[7.0].define(version: 20_230_821_162_549) do
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.index %w[user_id movierecord_id], name: 'index_likes_on_user_id_and_movierecord_id', unique: true
  ...
  create_table 'movierecord_tags', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[movierecord_id tag_id], name: 'index_movierecord_tags_on_movierecord_id_and_tag_id', unique: true
